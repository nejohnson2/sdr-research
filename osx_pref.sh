...
sudo scutil --set ComputerName uosdr
sudo scutil --set HostName uosdr
sudo scutil --set LocalHostName uosdr
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string uosdr
